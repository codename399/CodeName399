...
export class TradingSettingsComponent implements OnInit {
  ...
  readonly form = this.#fb.group({
    ...
    maxDailyLoss: [3000, [Validators.required, Validators.min(0)]],
    maxDailyTrades: [5, [Validators.required, Validators.min(1)]],
    cooldownMinutes: [10, [Validators.required, Validators.min(0)]],
    ...
    minimumVolume: [0, [Validators.required, Validators.min(0)]],
      ...
      .subscribe({
        next: (config: any) => {
          ...
          this.form.patchValue({
            ...
            maxDailyLoss: config?.maxDailyLoss ?? 3000,
            ...
            minimumPrice: equity.minimumPrice ?? 0,
            minimumVolume: equity.minimumVolume ?? 0,
  ...
  save(): void {
    ...
    const configuration = {
      ...
      maxDailyLoss: Number(v.maxDailyLoss),
      maxDailyTrades: Number(v.maxDailyTrades),
      ...
      equity: {
        ...
        minimumVolume: Number(v.minimumVolume),
